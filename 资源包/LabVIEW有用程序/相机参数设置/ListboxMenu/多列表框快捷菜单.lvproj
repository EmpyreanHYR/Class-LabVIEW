...
<Project Type="Project" LVVersion="16008000">
	<Item Name="我的电脑" Type="My Computer">
		...
		<Item Name="Menu" Type="Folder">
			...
			<Item Name="Move.lvclass" Type="LVClass" URL="../LNK/Move/Move.lvclass"/>
			<Item Name="UP.lvclass" Type="LVClass" URL="../LNK/UP/UP.lvclass"/>
			<Item Name="Down.lvclass" Type="LVClass" URL="../LNK/Down/Down.lvclass"/>
			<Item Name="Paste.lvclass" Type="LVClass" URL="../LNK/Paste/Paste.lvclass"/>
		...
		<Item Name="自定义控件" Type="Folder">
			<Item Name="自定义多列表框.xctl" Type="XControl" URL="../自定义多列表框/自定义多列表框.xctl"/>
		</Item>
