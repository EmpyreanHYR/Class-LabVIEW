...
<Library LVVersion="15008000">
	...
	<Item Name="操作者消息" Type="Folder">
		<Item Name="产生发送数据事件消息.lvclass" Type="LVClass" URL="../上位机 Messages/产生发送数据事件消息/产生发送数据事件消息.lvclass"/>
		<Item Name="产生接收数据用户事件消息.lvclass" Type="LVClass" URL="../上位机 Messages/产生接收数据用户事件消息/产生接收数据用户事件消息.lvclass"/>
		<Item Name="读取发送事件引用消息.lvclass" Type="LVClass" URL="../上位机 Messages/读取发送事件引用消息/读取发送事件引用消息.lvclass"/>
		<Item Name="读取接收事件引用消息.lvclass" Type="LVClass" URL="../上位机 Messages/读取接收事件引用消息/读取接收事件引用消息.lvclass"/>
	</Item>
	<Item Name="调用者抽象消息" Type="Folder"/>
	<Item Name="上位机.lvclass" Type="LVClass" URL="../上位机/上位机.lvclass"/>
</Library>
