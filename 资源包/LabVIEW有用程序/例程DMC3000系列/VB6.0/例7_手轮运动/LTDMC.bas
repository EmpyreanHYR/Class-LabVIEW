...
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
        ...
        Declare Function dmc_set_vector_s_profile Lib "LTDMC.dll" (ByVal CardNo As Integer, ByVal Crd As Integer, ByVal s_mode As Integer, ByVal s_para As Double) As Integer   '设置S型速度曲线参数
        Declare Function dmc_get_vector_s_profile Lib "LTDMC.dll" (ByVal CardNo As Integer, ByVal Crd As Integer, ByVal s_mode As Integer, ByRef s_para As Double) As Integer   '读取S型速度曲线参数
        ...
        Declare Function dmc_conti_set_speed_unit Lib "LTDMC.dll" (ByVal CardNo As Integer, ByVal Crd As Integer, ByVal Max_Vel As Double) As Integer   '设置连续插补运行速度
        Declare Function dmc_conti_set_taccdec Lib "LTDMC.dll" (ByVal CardNo As Integer, ByVal Crd As Integer, ByVal Taccdec As Double) As Integer     '设置连续插补速度曲线的加减速时间
        ...
        Declare Function dmc_set_pwm_onoff_duty Lib "LTDMC.dll" (ByVal CardNo As Integer, ByVal pwmno As Integer, ByVal fOnDuty As Double, ByVal fOffDuty As Double) As Integer
        Declare Function dmc_get_pwm_onoff_duty Lib "LTDMC.dll" (ByVal CardNo As Integer, ByVal pwmno As Integer, ByRef fOnDuty As Double, ByRef fOffDuty As Double) As Integer
        Declare Function dmc_conti_delay_pwm_to_start Lib "LTDMC.dll" (ByVal CardNo As Integer, ByVal Crd As Integer, ByVal pwmno As Integer, ByVal on_off As Integer, ByVal delay_value As Double, ByVal delay_mode As Integer, ByVal ReverseTime As Double) As Integer
        Declare Function dmc_conti_delay_pwm_to_stop Lib "LTDMC.dll" (ByVal CardNo As Integer, ByVal Crd As Integer, ByVal pwmno As Integer, ByVal on_off As Integer, ByVal delay_time As Double, ByVal ReverseTime As Double) As Integer
        Declare Function dmc_conti_ahead_pwm_to_stop Lib "LTDMC.dll" (ByVal CardNo As Integer, ByVal Crd As Integer, ByVal pwmno As Integer, ByVal on_off As Integer, ByVal ahead_value As Double, ByVal ahead_mode As Integer, ByVal ReverseTime As Double) As Integer
        Declare Function dmc_conti_write_pwm Lib "LTDMC.dll" (ByVal CardNo As Integer, ByVal Crd As Integer, ByVal pwmno As Integer, ByVal on_off As Integer, ByVal ReverseTime As Double) As Integer
        
        Declare Function dmc_line_unit1 Lib "LTDMC.dll" (ByVal CardNo As Integer, ByVal Crd As Integer, ByVal AxisNum As Integer, ByRef AxisList As Integer, ByRef Target_Pos As Double, ByVal posi_mode As Integer, ByVal MaxVel As Double, ByVal Taccdec As Double, ByVal Tspara As Double) As Integer
        Declare Function dmc_arc_move_center_unit1 Lib "LTDMC.dll" (ByVal CardNo As Integer, ByVal Crd As Integer, ByVal AxisNum As Integer, ByRef AxisList As Integer, ByRef Target_Pos As Double, ByRef Cen_Pos As Double, ByVal Arc_Dir As Integer, ByVal MyCircle As Long, ByVal posi_mode As Integer, ByVal MaxVel As Double, ByVal Taccdec As Double, ByVal Tspara As Double) As Integer
        Declare Function dmc_arc_move_radius_unit1 Lib "LTDMC.dll" (ByVal CardNo As Integer, ByVal Crd As Integer, ByVal AxisNum As Integer, ByRef AxisList As Integer, ByRef Target_Pos As Double, ByVal Arc_Radius As Double, ByVal Arc_Dir As Integer, ByVal MyCircle As Long, ByVal posi_mode As Integer, ByVal MaxVel As Double, ByVal Taccdec As Double, ByVal Tspara As Double) As Integer
        Declare Function dmc_arc_move_3points_unit1 Lib "LTDMC.dll" (ByVal CardNo As Integer, ByVal Crd As Integer, ByVal AxisNum As Integer, ByRef AxisList As Integer, ByRef Target_Pos As Double, ByRef Mid_Pos As Double, ByVal MyCircle As Long, ByVal posi_mode As Integer, ByVal MaxVel As Double, ByVal Taccdec As Double, ByVal Tspara As Double) As Integer
        Declare Function dmc_conti_line_unit1 Lib "LTDMC.dll" (ByVal CardNo As Integer, ByVal Crd As Integer, ByVal AxisNum As Integer, ByRef AxisList As Integer, ByRef Target_Pos As Double, ByVal posi_mode As Integer, ByVal mark As Long, ByVal MaxVel As Double, ByVal Taccdec As Double, ByVal Tspara As Double) As Integer
